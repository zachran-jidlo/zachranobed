/**
 * DEPRECATED: This function was replaced by checkOrdersFunction.
 *
 * Kept for reference only. The GitHub Actions trigger logic has been migrated
 * to checkOrdersFunction which runs directly as a scheduled Cloud Function.
 *
 * Migration Date: 2026-01-30
 * Replacement: src/functions/checkOrdersFunction.ts
 */
