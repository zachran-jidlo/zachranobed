...
class LoginDependencyContainer {
  ...
  static void setup() {
    ...
    GetIt.I.registerFactory<SignInUseCase>(() => SignInUseCase(GetIt.I<UserRepository>()));
    GetIt.I.registerFactory<ChangePasswordUseCase>(() => ChangePasswordUseCase(GetIt.I<UserRepository>()));
    GetIt.I.registerFactory<ResetPasswordUseCase>(() => ResetPasswordUseCase(GetIt.I<UserRepository>()));
  }
}
