...
import 'package:zachranobed/features/forceupdate/presentation/force_update_screen.dart'
    as _i14;
import 'package:zachranobed/features/inactiveaccount/presentation/inactive_account_screen.dart'
    as _i17;
...
class BoxDeliveryConfirmationRoute
    extends _i28.PageRouteInfo<BoxDeliveryConfirmationRouteArgs> {
...
class FaqQuestionsRouteArgs {
  ...
  bool operator ==(Object other) {
    ...
    return key == other.key &&
        const _i32.ListEquality().equals(items, other.items);
  }
...
class FoodBoxesCheckupMismatchRoute
    extends _i28.PageRouteInfo<FoodBoxesCheckupMismatchRouteArgs> {
...
class FoodBoxesCheckupMismatchRouteArgs {
  ...
  bool operator ==(Object other) {
    ...
    return key == other.key &&
        user == other.user &&
        const _i32.ListEquality().equals(statistics, other.statistics);
  }

  @override
  int get hashCode =>
      key.hashCode ^ user.hashCode ^ const _i32.ListEquality().hash(statistics);
}

/// generated route for
/// [_i13.FoodBoxesDetailScreen]
class FoodBoxesDetailRoute
    extends _i28.PageRouteInfo<FoodBoxesDetailRouteArgs> {
...
class MealSuggestionEditRoute
    extends _i28.PageRouteInfo<MealSuggestionEditRouteArgs> {
...
class OfferFoodBoxesRouteArgs {
  ...
  @override
  int get hashCode =>
      key.hashCode ^ const _i32.MapEquality().hash(currentBoxesQuantity);
}

/// generated route for
/// [_i21.OfferFoodEditExistingScreen]
class OfferFoodEditExistingRoute
    extends _i28.PageRouteInfo<OfferFoodEditExistingRouteArgs> {
...
class OfferFoodOverviewRoute
    extends _i28.PageRouteInfo<OfferFoodOverviewRouteArgs> {
...
class OfferFoodOverviewRouteArgs {
  ...
  @override
  int get hashCode =>
      key.hashCode ^ const _i32.ListEquality().hash(initialFoodInfos);
}
