...
class ConfigurationContactsDto {
  ...
  ConfigurationContactsDto({required this.organisationContacts});

  factory ConfigurationContactsDto.fromJson(Map<String, dynamic> json) => _$ConfigurationContactsDtoFromJson(json);
