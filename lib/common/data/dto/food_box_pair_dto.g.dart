...
FoodBoxPairDto _$FoodBoxPairDtoFromJson(Map<String, dynamic> json) => FoodBoxPairDto(
...
Map<String, dynamic> _$FoodBoxPairDtoToJson(FoodBoxPairDto instance) => <String, dynamic>{
